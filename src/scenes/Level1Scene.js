...
export class Level1Scene extends BaseLevel {
  ...
  onPipeReached() {
    ...
    this.popup.show(
      ...
      earned
        ? 'You rejected all three seed corporations, large scale seed companies like these patent and monopolize seed genetics, forcing farmers to repurchase seeds every season rather than saving them. This practice eliminates thousands of locally adapted crop varieties that have been cultivated for decades. By supporting seed diversity, you help preserve the genetic resilience that protects food systems against disease, drought, and climate change. Diverse crops mean a more stable food supply for everyone.'
